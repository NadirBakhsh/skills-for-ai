...
description: >-
  ...
  successor) for React, Next.js, Svelte, and Astro projects. Use when the user
  requests animation, motion, scroll effects, parallax, hero animations,
  gestures, drag interactions, spring physics, whileHover, whileInView, animated
  UI, micro-interactions, page transitions, or layout animations. Generates
  production TypeScript/JSX with prefers-reduced-motion and ≥60fps targets.
  Do NOT use for CSS-only transitions, static sites without JS, Vue (use motion-v),
  or complex SVG/Canvas animations (use GSAP).
---

# Motion Dev Animations

> **Upstream**: [199-biotechnologies/motion-dev-animations-skill](https://github.com/199-biotechnologies/motion-dev-animations-skill) (MIT)
> **Motion.dev** — successor to Framer Motion. GPU-accelerated animations for React, Next.js, Svelte, Astro.
...
- Install and sync: [reference.md](reference.md)
- Upstream repo: [motion-dev-animations-skill](https://github.com/199-biotechnologies/motion-dev-animations-skill)
